...
// // 		 EventSubscriber <Events::OnEntityCreated>, public
// // 		 EventSubscriber <Events::OnEntityDestroyed>, public
...
// 	// std::cout << "Initial values: position(" << pos->x << "
// 	// , " << pos->y << "), rotation(" << rot->angle << ")" << std::endl;
